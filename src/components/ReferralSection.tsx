      ...
      <Card className="bg-gradient-to-br from-secondary/10 to-secondary/5">
        ...
        <CardContent className="space-y-2 text-sm">
          ...
          <div className="flex items-start gap-2">
            ...
            <p>Friends sign up using your code or link</p>
          </div>
          <div className="flex items-start gap-2">
            <div className="h-6 w-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
              3
            </div>
            <p>When they complete their first pickup, you both earn rewards!</p>
          </div>
          <div className="flex items-start gap-2">
            <div className="h-6 w-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
              💰
            </div>
            <p className="font-medium text-primary">Earn ₦500 per successful referral</p>
          </div>
        </CardContent>
      </Card>
    </div>
