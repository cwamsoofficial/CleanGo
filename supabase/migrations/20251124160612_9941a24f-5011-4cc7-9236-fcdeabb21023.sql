-- Update the update_user_streak function to award 10 points instead of 20 points per pickup
...
BEGIN
  ...
  -- Award base points for pickup completion (10 points instead of 20)
  PERFORM award_points(_user_id, 10, 'Pickup completion');
